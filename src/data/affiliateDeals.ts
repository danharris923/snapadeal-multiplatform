...
export const affiliateDeals: Deal[] = [
  // Amazon Electronics
  {
    ...
    title: 'Amazon Electronics Sale Portal',
    description: 'Lightning deals, daily discounts & warehouse finds on tech essentials',
    price: null,
    original_price: null,
  ...
  // Walmart General
  {
    ...
    title: 'Walmart Daily Deals',
    description: 'Fresh daily deals updated every 24 hours - rollback prices on top brands',
    price: null,
    original_price: null,
    discount_percentage: null,
    store: 'Walmart',
  ...
  // Lululemon Fashion
  {
    ...
    description: 'They made too much! Score discounted athletic wear & accessories',
    price: null,
    original_price: null,
    discount_percentage: null,
    store: 'Lululemon',
  ...
  // Roxy Fashion
  {
    ...
    title: 'Roxy Seasonal Clearance',
    description: 'Hottest swimwear & beach fashion - end of season clearance prices',
    price: null,
    original_price: null,
    discount_percentage: null,
    store: 'Roxy',
